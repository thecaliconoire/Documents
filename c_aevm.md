...
Gas prices might differ for AE, schema: [opcode, ins, outs, gas, arguments]

The aeternity virtual machine makes data easier to read then looking at raw JSON data. The below section is where the operation codes are defined. Operation codes tell the system what operations to conduct.
